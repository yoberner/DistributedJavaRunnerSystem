...
public class UDPMessageReceiver extends Thread implements LoggingServer {
    ...
    public UDPMessageReceiver(LinkedBlockingQueue<Message> incomingGossipMessages, LinkedBlockingQueue<Message> incomingMessages, InetSocketAddress myAddress, int myPort, ZooKeeperPeerServer peerServer) throws IOException {
        this.incomingMessages = incomingMessages;
